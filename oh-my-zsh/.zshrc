...
# Setting this variable when ZSH_THEME=rand
# cause zsh load theme from this variable instead of
# looking in ~/.oh-my-zsh/themes/
# An empty array have no effect
# ZSH_THEME_RANDOM_CANDIDATES=( "robbyrussell" "nt9"  "agnoster" )
...
# User configuration
# if [[ -r ~/.local/lib/python3.8/site-packages/powerline/bindings/zsh/powerline.zsh ]]; then
...
#Symlink to the .zshrc in home directory
